...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        className={`hidden md:flex h-screen bg-gradient-to-b from-[#1c1c1c] to-[#121212] p-4 flex-col text-white border-r border-gray-800 transition-all duration-300
      ...
      <div className="mt-6 flex-1 overflow-y-auto">
        <div className="bg-[#181818]/70 backdrop-blur-md rounded-xl p-4 border border-gray-700 mb-4 flex flex-col items-center">
          {collapsed ? (
        ...
        <div className="bg-[#181818]/70 backdrop-blur-md rounded-xl p-4 border border-gray-700 flex flex-col items-center">
          {collapsed ? (
